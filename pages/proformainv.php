...
{
$val=$_GET['inv'];
$invdata=mysqli_query($con,"SELECT protest2.invid, protest2.orderid,client.c_name,client.c_add,client.mob,client.gst, client.country,client.c_type,protest2.created, protest2.subtotal,protest2.taxrate,protest2.taxamount,protest2.totalamount FROM `protest2`join client where protest2.cid=client.cid and invid='$val'")
...
<tr height="13">
    <td height="13" colspan="8" style="border:1px solid black;"><img src="letterpad/sticker Letter Pad .png" height="200px" width="870px">  </td>
  </tr>
  
 <td colspan="8" height="24" style="border:1px solid black;border-bottom:0px;font-size:20px"><div style="float: left"><b>&nbsp; GSTIN:&nbsp; <?php echo $pgst; ?> </b><strong style="font-size:24px; margin-left: 100px;">Proforma Invoice</strong><b style="padding-left:120px;">&nbsp; IEC:&nbsp; <?php echo $ppan; ?> </b></div></td>
  </tr>
  ...
  <tr height="20">
    ...
    <td colspan="2" id="br"><b><?php echo $invid; ?></b></td>
