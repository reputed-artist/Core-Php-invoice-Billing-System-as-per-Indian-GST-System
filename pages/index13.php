...
<div class="wrapper">
 ...
 <?php include_once"header.php";?>
        ...
        <div class="col-md-9" >
          ...
          <div class="box box-info col-md-9" style="overflow: auto;" >
           ...
           <div class="progress-group">
                    ...
                    <span class="progress-number"><b><?php echo $ro['item_sold']; ?></b>/100</span>

                    <div class="progress sm">
                      <div class="progress-bar progress-bar-<?php echo $colors[$i]; ?>" style="width:<?php $r=(100*$ro['item_sold'])/100; echo $r; ?>%"></div>
                    </div>
                  </div>              
                    <?php $i+=1; 
                       }
  ...
  <div class="col-md-3 box-body timer">
      ...
      <!-- <div class="col-md-6 box-body">
       ...
       <div class="col-md-3 box-body" style="padding-right: 16px;">
          ...
          <div class="box box-info" style="height: 425px;">
            ...
            <div class="box-body chart-responsive">
              <div id='chart_pie_6' class='chart_morris' style="height: 300px;"></div>
...
$('#calendar').datepicker();
         ...
         $('#brand').change(function(){  
              ...
              //b is parameter variable
                  ...
                  hoverCallback: function(index, options, content, row) {
                    ...
                    Morris.Donut({
                    element: 'chart_pie_6', // ID of the container
                    data: [
                    ...
                    colors: ['#0b62a4', '#7a92a3', '#4da74d', '#afd8f8'], // Custom colors
                    resize: true, // Make chart responsive
                    formatter: function (y) {
                      return y + '%'; // Format the values
                    }
                  });
 ...
 var options = {
   ...
   var options = {
    ...
    var chart = new ApexCharts(document.querySelector("#ebar-funnel"), options);
    chart.render();
