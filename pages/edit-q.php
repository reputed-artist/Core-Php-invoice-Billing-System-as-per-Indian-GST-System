...
if(isset($_GET['invid']))
{
  ...
  $invid=$_GET['invid'];
  $invdata=mysqli_query($con,"select * from quote2 where invid='$invid'");
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
       ...
       <?php $ret=mysqli_query($con,"select (invid)+1 from quote2 ORDER BY invid DESC LIMIT 1")or die("Error: " . mysqli_error($con));
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label id="cid" class="col-sm-2 control-label">Quotation ID</label>
                  <div class="col-sm-3">
                    <input type="text" class="form-control" name="quoteid" id="quoteid" value="<?php echo $invid; ?>">
...
<!--               <th width="20%">Description Name</th> -->
     ...
     <?php 
            ...
            $items=mysqli_query($con,"select * from quote where orderid='$orderid'")or die("Error".mysqli_error($connect));

            //echo "select * from quote where orderid='$orderid'";
...
<?php } ?>
      ...
      <div class="row"> 
        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8" style="padding-left: 50px;">
          <h3>Notes: </h3>
          <div class="form-group">
            <textarea class="form-control txt" rows="5" name="notez" id="notez" placeholder="Your Notes"><?php echo $notes; ?></textarea>
          </div>
          <br>
          <div class="form-group">
...
console.log(encodedstr);
 ...
 //var formData = new FormData(document.getElementById("form"));
        ...
        $.ajax({
            type: "POST",
            url: "ajax/editquotationtest.php",
            data: formData,
            dataType: 'json', 
            //contentType: false,           
