        ...
        <div class="col-xs-12">
          ...
          <div class="box box-info" style="overflow: auto;">
            <div class="box-header">
              <h3 class="box-title" style="padding-top: 10px;"> All Suppliers</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped">
                            
                            <button type="button" id="btnplus" class="btn btn-success btn-sm pull-right" style="margin: 2px 20px 2px 2px;" onclick="window.location.href = 'add-supplier.php'";><span class="glyphicon glyphicon-plus"></span></button></br> 
                            <hr>
                              <thead>
                              <tr>
                                  <th>Sr. no.</th>
                                  <th class="hidden-phone">Supplier Name</th>
              ...
              <div  class="btn-group" data-toggle="buttons" role="group">
                ...
                <input type="button" class="toggle-vis btn btn-primary" data-column="1" value="Supplier Name">
                <input type="button" class="toggle-vis btn btn-primary" data-column="2" value="Supplier Address">
                <input type="button" class="toggle-vis btn btn-primary" data-column="3" value="Mob">
                <input type="button" class="toggle-vis btn btn-primary" data-column="4" value="Email">
                <input type="button" class="toggle-vis btn btn-primary" data-column="5" value="GST">
                <input type="button" class="toggle-vis btn btn-primary" data-column="6" value="Supplier Type">
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
  ...
  exportOptions: {
    ...
    render: function (data, type, row, meta) {
      ...
      {mData:'editaction',
            ...
            render: function (data, type, row, meta) {
              var pcidValue = row.pcid;


      return '<a href="update-supplier.php?pcid=' + pcidValue + '"><button class="btn btn-primary btn-xs" style="width:30px;height:25px"><i class="fa fa-pencil"></i></button></a>';
    }},
    {
      mData:'viewaction',
      render: function (data, type, row, meta) {
      ...
      return  '<a href="get-supplierinfo.php?infoid=' + cidValue + '"><button class="btn btn-warning btn-xs" style="width:30px;height:25px"><i class="fa fa-fw fa-eye"></i></button></a>';
    }},

    {
      mData:'deleteaction',
      render: function (data, type, row, meta) {
              var pidValue = row.pcid;
