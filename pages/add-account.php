...
<?php include_once"header.php"; ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <?php $ret=mysqli_query($con,"select (aid)+1 from account ORDER BY aid DESC LIMIT 1")or die("Error: " . mysqli_error($con));
            ...
            <!-- <form class="form-horizontal"> -->
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="aid" id="aid" value="<?php echo $row[0];?>" readonly>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select name="clog" id="clog" class="form-control select2" disabled>
                    <option value=""></option>
                   </select>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-8">
                   <input type="number" class="form-control" name="opbal" id="opbal" placeholder="Opening Balance">
...
<script>
  ...
  $("form").submit(function(event) {
        ...
        //            $('.error').removeClass('error');
                    ...
                    Swal.fire({
                    title: "Good!",
                    text: "New Account Data Inserted!",
                    icon: "success",
