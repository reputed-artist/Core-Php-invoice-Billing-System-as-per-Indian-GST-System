...
$current_page="manage-purinv";
//$current_page1="manage-purinv";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Generate Supplier Invoice</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Generate Supplier Invoice</h3>
            </div>
          </br>
           <p align="center" style="color:#F00;"><?php 
                     ...
                     echo $_SESSION['msg']; }?><?php echo $_SESSION['msg']=""; ?></p>
                      ...
                      <form class="form-horizontal style-form form" name="form" id="form"  method="post" action="">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="text" class="form-control" name="invid" id="invid">
                    <div id="invid_error" style="color: red;"> </div>
                  </div>
                      <label id="c_addlbl1" class="col-sm-2 control-label">Supplier Name</label>
    
                    <div class="col-sm-4">
                    <select name="supplier" class="form-control select2" onchange="showCustomer(this.value)" style="height:40px !important;width: 80%;border-radius:0px; ">
                                 <option></option>
