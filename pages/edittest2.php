...
if(isset($_GET['invid']))
{
  ...
  $invid=$_GET['invid'];
  $invdata=mysqli_query($con,"select * from protest2 where invid='$invid'");
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label id="cid" class="col-sm-2 control-label">Proforma ID</label>
                  <div class="col-sm-3">
                    <input type="text" class="form-control" name="pinvid" id="pinvid" value="<?php echo $invid; ?>">
                    <div id="pinvid_error" style="color: red;"> </div>
                  </div>

                  <label id="c_addlbl1" class="col-sm-2 control-label">Client Name</label>
                  <div class="col-sm-4">
                    <select name="client" id="client" onchange="showCustomer(this.value)" class="form-control select2" 
                    style="width: 80%;border-radius:0px;">
                                ...
                                else if ((isset($clientname)) && ($ro['c_name'] == $clientname))
                                {
                                              // echo "Enters else if";
                                  ?>

                                  <option value="<?php echo $ro['cid']; ?>" selected="selected"> <?php echo $clientname;
                ...
                <div class="form-group">
                  <label id="datelbl" class="col-sm-2 control-label">Invoice Date</label>
                  <div class="col-sm-3">
     ...
     <?php 
            ...
            $items=mysqli_query($con,"select * from protest where orderid='$orderid'")or die("Error".mysqli_error($connect));
...
<?php } ?>
 ...
 $(document).on('click', '.add', function(){
  ...
  html += ' <td><input type="text" name="productCode[]" id="productCode_'+rowCount+'" value='+rowCount+' class="form-control" autocomplete="off"></td>';
...
console.log(encodedstr);
 ...
 //var formData = new FormData(document.getElementById("form"));
        ...
        //            $('.error').removeClass('error');
                 ...
                 window.open('proformainv.php?inv='+response.invid, '_blank');
