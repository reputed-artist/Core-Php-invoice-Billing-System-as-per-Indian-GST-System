...
<table width="816" height="1056" cellpadding="0" cellspacing="0" style="font-family:calibri;margin-top:10px;" align="center">
  ...
  <col width="73" />
  <tr height="26">
    <td colspan="8" height="24" style="border:1px solid black;border-bottom:0px;font-size:16px"><div align="center"><strong style="font-size:20px; ">Tax Invoice</strong></div></td>
  </tr>
  <tr height="13">
...
<tr height="20">
  ...
  <tr height="24">
    ...
    <td style="border-bottom:1px solid black;border-right:1px solid black;" ><div align="center"></div></td>
    <td style="border-bottom:1px solid black;border-right:1px solid black;width: 83px;" ><div align="center"><?php echo number_format($taxamount/2,2); ?></div></td>
    <td style="border-bottom:1px solid black;border-right:1px solid black;" ><div align="center"><?php echo number_format($taxamount,2); ?></p></div></td>
  </tr>
  <tr height="34">
