            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="pcname" name="pcname" value="<?php echo $row['pcname'];?>">
...
<!-- 
              <div class="form-group">
                  ...
                  <div class="col-sm-8">
                   <input type="text" class="form-control" name="pcmob" id="pcmob" value="<?php echo $row['pcmob'];?>" minlength="10"  maxlength="10">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-8">
                   <input type="email" class="form-control" name="email" id="hsn" value="<?php echo $row['email'];?>" >
                                  <div id="email"> </div>
                </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" style="text-transform: uppercase;" class="form-control" name="gst" maxlength="15" 
                    minlength="10" value="<?php echo $row['gst'];?>">
                    <div id="gst_error" style="color: red"> </div>
                </div>
              </div>

                <div class="form-group">
                  <label id="typelbl" class="col-sm-2 control-label">Supplier Type</label>
                  <div class="col-sm-8">
                   <select name="pcomtype" id="pcomtype" class="form-control select2"  style="width: 100%; height: 34px; border-radius: 0px !important;">
...
<script>
  $(function () {
    ...
    $('.select2').select2({
       placeholder: "Select a Debitors Type",
    allowClear: true
    });
...
<script>
    ...
    $("form").submit(function(event) {
        ...
        var formData = $(this).serialize();
         ...
         formData += '&pcid=' + encodeURIComponent(pcid);
   
        // var formData = $(this).serialize();
        $.ajax({
            type: 'POST',
            url: 'ajax/updatesuppliertest.php',
