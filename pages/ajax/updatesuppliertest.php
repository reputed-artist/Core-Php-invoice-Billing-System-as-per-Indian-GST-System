...
else
{
 ...
 if($try == 5)
 {
  $c=mysqli_query($con,"update purchasecom set pcname='$pcname' ,pcadd='$pcadd' , pcmob='$mob', email='$email', gst='$gst',pcomtype='$pcomtype', created='$date' where pcid='".$pcid."'") or die("Error: " . mysqli_error($con));

//echo "update purchasecom set pcname='$pcname' ,pcadd='$pcadd' , pcmob='$mob', email='$email', gst='$gst',pcomtype='$pcomtype', created='$date' where pcid='".$pcid."'";
